<template>
    ...
    <el-card class="box-card">
      ...
      <div style="margin-left: 370px;margin-top:15px;margin-bottom: 15px;"><h3>table</h3></div>
      <el-table :data="commits"  style="width: 70%;margin-left:150px;padding-left: 30px;padding-top:15px;padding-right: 20px;">
